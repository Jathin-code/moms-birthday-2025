  ...
  return (
    <section id="scroll-of-love" ref={ref} className="relative w-full py-24 md:py-32 bg-background">
      <div className="container mx-auto px-4 z-10 flex flex-col items-center">
        <h2 className={`text-center font-display text-4xl md:text-6xl mb-12 md:mb-16 text-foreground transition-opacity duration-1000 ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
